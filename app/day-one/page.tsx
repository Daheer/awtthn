    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4 space-y-8">
            ...
            <h1 className="text-3xl font-bold text-center">
                 <span className='text-gray-400'>Election</span> Day One
            </h1>
            ...
            {isVotingOpen ? (
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6">
                    <Button
                        ...
                        onClick={() => handleVoteClick('president')}
                    >
                        Vote for President
                    </Button>
                    <Button
                        ...
                        onClick={() => handleVoteClick('vice-president')}
                    >
                        Vote for Vice President
                    </Button>
                </div>
            ) : (
                <p className="text-xl text-center text-red-500">Voting closed/voting not open yet. Please check back between 8 AM and 8 PM on January 6th.</p>
            )}
        </div>
    );
}
